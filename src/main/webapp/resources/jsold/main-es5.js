(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BodyComponent = /** @class */ (function () {
                function BodyComponent(dataService) {
                    this.dataService = dataService;
                }
                BodyComponent.prototype.ngOnInit = function () {
                    this.informe = this.dataService.valores[0].id;
                };
                BodyComponent.prototype.showInform = function (mensaje) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ContenDerComponent = /** @class */ (function () {
                ...
                ContenDerComponent.prototype.toPdf = function () {
                    var url = 'https://url-to-pdf-api.herokuapp.com/api/render?';
                    var params = 'pdf.landscape=true&viewport.width=900&pdf.margin.top=100&pdf.margin.left=100&url=';
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TranslateService = /** @class */ (function () {
                ...
                TranslateService.prototype.getData = function () {
                    var _this = this;
                    return new Promise(function (resolve, reject) {
                        _this.http.get('admin/resources/assets/translations/' + navigator.language + '.json')
                            .subscribe(function (data) {
                            _this.data = data;
                            resolve(true);
                        }, function (error) {
